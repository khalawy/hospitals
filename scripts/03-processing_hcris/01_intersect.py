...
# print 'convert input nad 83 counties 2000 file and bring into na albers equal area conic'
# arcpy.FeatureClassToFeatureClass_conversion(fld+"/input/census/census_2000_counties/tl_2008_us_county/tl_2008_us_county.shp",fld+"/processing/processing.gdb/na_albers_equal_area_conic","county_2000")
...
#Probably don't need to rerun the steps above. 
...
print "intersect points to get county"
inFeatures = [fld+"/processing/processing.gdb/na_albers_equal_area_conic/points", fld+"/processing/processing.gdb/na_albers_equal_area_conic/county_2000"]
arcpy.Intersect_analysis(inFeatures,fld+"/processing/processing.gdb/na_albers_equal_area_conic/points_intersect_county","ALL","#","INPUT")
...
dissolve_on = "prvdr_num;uidpreint;bufferareasqmeters;CTIDFP00;tractareasqmeters"
...
print "dissolve points tract intersect by county"
...
#GET RID OF 2010 TRACTS ONLY NEED TO DO COUNTIES!!!!!! for health insurance uses 2000  county data
